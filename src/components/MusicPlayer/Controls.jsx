...
const Controls = ({ isPlaying, repeat, setRepeat, shuffle, setShuffle, currentSongs, handlePlayPause, handlePrevSong, handleNextSong }) => (
  <div className="flex items-center justify-around md:w-36 lg:w-52 2xl:w-80">
    ...
    {currentSongs?.length && <MdSkipPrevious size={30} color="#FFF" className="cursor-pointer prev" onClick={handlePrevSong} />}
    {isPlaying ? (
    ...
    {currentSongs?.length && <MdSkipNext size={30} color="#FFF" className="cursor-pointer next" onClick={handleNextSong} />}
